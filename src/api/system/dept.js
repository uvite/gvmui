...
export default {
  ...
  getList(params = {}) {
    return request({
      url: 'systemDept/getSystemDeptList',
      method: 'get',
      params
    })
  },
  ...
  tree() {
    return request({
      url: 'systemDept/getSystemDeptTree',
      method: 'get'
    })
  },
  ...
  save(params = {}) {
    return request({
      url: 'systemDept/createSystemDept',
      method: 'post',
      data: params
    })
  },
  ...
  deletes(data) {
    return request({
      url: 'systemDept/deleteSystemDeptByIds',
      method: 'delete',
      data
    })
  },
  ...
  update(id, params = {}) {
    return request({
      url: 'systemDept/updateSystemDept',
      method: 'put',
      data: params
    })
  },
