    ...
    <ma-crud :options="crud" :columns="columns" ref="crudRef">
      ...
      <template #operationBeforeExtend="{ record }">
        <a-link
          ...
          v-if=" record.meta.type === 'M' && ! isRecovery "
...
<script setup>
  ...
  const crud = reactive({
    ...
    beforeAdd: (form) => {
      ...
      form.is_hidden=parseInt(form.is_hidden)
      form.meta={}

      form.meta.type=form["meta.type"]
      form.meta.redirect=form["redirect"]
  ...
  const columns = reactive([
    { title: 'ID', dataIndex: 'id', addDisplay: false, editDisplay: false, width: 50, hide: true },
    {
      ...
      dict: { url: 'menu/getMenuTree',method:"post",props:{customField:"name",title:"name",key:"ID"}, params: { onlyMenu: true } }, addDefaultValue: 0,
