<template>
  <div>
    ...
    <div class="gva-search-box">
      <el-collapse v-model="activeNames" style="margin-bottom:12px">66
        <el-collapse-item name="1">77

          <el-form ref="getTableForm" style="margin-top:24px" :inline="true"   label-width="120px">

           888 <el-form-item label="业务库" prop="selectDBtype">
